...
def _scaffold_check() -> None:
    required = [
        ...
        _LAB_ROOT / "learning" / "outcome_simulator.py",
        _LAB_ROOT / "synthetic_dataset.py",
        _LAB_ROOT / "run_ab_comparison.py",
        _LAB_ROOT / "configs" / "default_lab_config.json",
        _LAB_ROOT / "configs" / "stub_lab_config.json",
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        help="Path to agent lab config JSON (default: LLM/Qwen via configs/default_lab_config.json; offline: configs/stub_lab_config.json)",
    )
    parser.add_argument(
        "--output-dir",
        type=str,
