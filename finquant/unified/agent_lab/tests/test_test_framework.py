...
from test_framework import run_test_pack
...
def test_run_test_pack_writes_summary():
    config = {
    ...
    test_pack = {
        "schema": "finquant_test_pack_v1",
        "pack_id": "tmp_learning_pack",
        "tests": [
            {
                "test_id": "memory_threshold_cycle",
                "seed_case_path": "seed.json",
                "candidate_case_path": "candidate.json",
                "expected_verdicts_v1": ["LEARNED_BEHAVIOR_PROVEN"],
                "expected_min_retrieval_matches_v1": 1
            }
        ]
    }
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        assert result["summary"]["overall_status_v1"] == "PASS"
        assert result["summary"]["tests_passed"] == 1
