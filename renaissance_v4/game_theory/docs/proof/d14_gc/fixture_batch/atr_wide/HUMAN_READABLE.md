...
- **run_id:** `bcd31c44-572f-4388-bd58-fd816fd3dbbb`
- **UTC:** 2026-04-21T23:00:22.874009+00:00
...
- **ATR overrides (CLI / scenario):** stop_mult=2.5, target_mult=4.0 (these override manifest values for this replay only when set).

## Hypothesis & indicator context (what you said you were testing)

> Wider ATR multiples (2.5 / 4.0) improve net PnL vs atr_tight by letting winners run on this bar history.
