...
- **run_id:** `cc4d2088-75a2-4fff-98b8-5f5c07974d5a`
- **UTC:** 2026-04-21T23:00:22.873945+00:00
...
- **ATR overrides (CLI / scenario):** stop_mult=1.5, target_mult=2.5 (these override manifest values for this replay only when set).

## Hypothesis & indicator context (what you said you were testing)

> Tighter ATR multiples (1.5 / 2.5) reduce drawdown vs default without destroying cumulative PnL on this window.
...
| Memory in use | **no** |
| Groundhog mode (canonical bundle) | **inactive** (active / inactive) |
...
- **Groundhog note:** No bundle merge — Groundhog file was not in effect for this run.
