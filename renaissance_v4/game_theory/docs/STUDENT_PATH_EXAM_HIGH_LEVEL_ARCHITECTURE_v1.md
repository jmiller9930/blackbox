...
**Status:** v1.29 — **GT_DIRECTIVE_023** learning effectiveness audit (**CLOSED**): `GET /api/training/learning-effectiveness`, materialize, `learning_effectiveness_report_v1`. **GT_DIRECTIVE_022** training export (**CLOSED**). **GT_DIRECTIVE_021** spec locked (not implemented). **§1.0.2** LLM mandatory thesis on sealed object. **016** CLOSED; **016R1** / **019** (reserved). **§18.1a** dictionary. **015** CLOSED; **018** v1. **017** precondition shipped.
