...
**Status:** v1.28 — **GT_DIRECTIVE_022** training export (**CLOSED**): `GET /api/training/export`, materialize, `training_record_v1`. **GT_DIRECTIVE_021** spec locked (not implemented). **§1.0.2** LLM mandatory thesis on sealed object. **016** CLOSED; **016R1** / **019** (reserved). **§18.1a** dictionary. **015** CLOSED; **018** v1. **017** precondition shipped.
