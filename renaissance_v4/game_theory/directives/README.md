...
- **`GT_DIRECTIVE_028_*`** — RM refactor **Directive 0** (architecture alignment — centralize the brain).
- **`GT_DIRECTIVE_029_*`** — RM refactor **Directive 1** (quant/perps **data & math capability audit** — mandatory before state/EV/similarity implementation).
