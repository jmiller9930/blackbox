...
PATTERN_GAME_WEB_UI_VERSION = "2.19.113"
        ...
        return jsonify(
            {
                **get_parallel_limits(),
                ...
                "pattern_game_student_llm_contract_repair_v1": bool(student_llm_contract_repair_enabled_v1()),
