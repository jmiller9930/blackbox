...
Details: `AGENTS.md`. Cody-specific files: `docs/cody/` and `agents/cody/`. **Full Phase 1 / OpenClaw master plan:** [`docs/blackbox_master_plan.md`](docs/blackbox_master_plan.md) (includes **Phase 2+ [STUB]** — Decision Layer / Analyst model roadmap for auditable trade reasoning and trade-team learning). **Phase 1 team clarification (OpenClaw first, Slack later):** [`docs/CURSOR_PHASE1_CLARIFICATION.md`](docs/CURSOR_PHASE1_CLARIFICATION.md).
