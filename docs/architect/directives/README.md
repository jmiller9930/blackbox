...
| **DV-ARCH-POLICY-LOAD-028** | Unified policy submission — Kitchen-first, no live assignment without evaluation | [`../DV-ARCH-POLICY-LOAD-028_unified_policy_submission.md`](../DV-ARCH-POLICY-LOAD-028_unified_policy_submission.md) | **Documented** — implementation (unified pipeline, states, UI) pending |
