...
| **DV-ARCH-CLARIFICATION-029** | Policy wiring — source of truth across surfaces (assignment, execution, ledger, dashboard, API) | [`../policy_wiring_surface_map_v1.md`](../policy_wiring_surface_map_v1.md) | **Documented** — `policy_wiring_surface_map_v1.md` |
