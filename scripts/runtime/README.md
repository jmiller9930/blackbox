...
| `DEEPSEEK_ESCALATION_OLLAMA_*` | **Internal DeepSeek R1 reviewer** — default model **`deepseek-r1:14b`** on **172.20.2.230** (prove with `scripts/verify_deepseek_escalation_ollama_v1.sh` after `ollama pull`). |
