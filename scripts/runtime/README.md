...
| `DEEPSEEK_ESCALATION_OLLAMA_*` | **Escalation / debug** — default model **`deepseek-v4-flash:cloud`** on **172.20.2.230** (prove with `scripts/verify_deepseek_escalation_ollama_v1.sh` after `ollama pull` + cloud auth on that host). |
