...
| `DEEPSEEK_ESCALATION_OLLAMA_*` | **Escalation / debug** only (default `deepseek-r1:14b` on **172.20.2.230** when present in `ollama list`; use env for other tags e.g. cloud models after pull/auth). |
